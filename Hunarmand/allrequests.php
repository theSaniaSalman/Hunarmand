...
<button class="tablink" onclick="openPage('For masons', this, 'light blue')"> For Painters</button>
<button class="tablink" onclick="openPage('ForHouseCleaning', this, 'light blue')"> For House Cleaning</button>
<button class="tablink" onclick="openPage('ForEducation', this, 'light blue')"> For Masons</button>
...
<div id="MyRequests" class="tabcontent">
    ...
    while($row=mysqli_fetch_array($executeRequestQuery))
            ...
            ?><div id="in-div"><a href="profilepage.php"><?php echo $Uname; ?></a><div></div><?php echo $request?><div></div><a href="assignWork.php?REQUEST=<?php echo $request;?>&REQUESTID=<?php echo $requestId;?>"><?php echo $noOfBids." "?>workers want to work on this</a></div>
               <?php  
               }
     ?>
...
<div id="Formasons" class="tabcontent">
<?php
...
<?php
    $requestQuery2="SELECT * FROM buyerreq WHERE category='Mason'";
    $executeRequestQuery2=mysqli_query($conn,$requestQuery2);
    while($row2=mysqli_fetch_array($executeRequestQuery2))
    {   $buyer2=$row2[2];
        $request2=$row2[3];
