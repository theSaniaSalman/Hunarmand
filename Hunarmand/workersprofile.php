...
if($_SESSION["user_login"]==null)
  ...
  if(isset($_POST['updatebutton'])){
	  if(($_POST['fullname'] == "" || $_POST['pnumber'] == "" || $_POST['email'] == "" || $_POST['address'] == "" || $_POST['password'] == "")){
		  ...
		  $sql = "UPDATE workerregistration SET fullName = '$fullname', phoneNum = '$PHONENUMBER', email = '$EMAIL', addresss = '$ADDRESS', password = '$PASSWORD', workCategory = '$WORKCATEGORY',imgsrc = '$folder WHERE userName='".$_SESSION['user_login']."'";
