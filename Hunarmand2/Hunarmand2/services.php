...
<body>
    ...
    <div id="header" class="sticky-top">
        ...
        <div class="services8">
            ...
            <div class="box" onclick="location.href='allservices.php?work-category=<?php echo 'AC Technician';  ?>';">
                <img src="images/icons8-air-conditioner-96.png">
                <h4>AC TECHNICIAN</h4>
            </div>
            <div class="box" onclick="location.href='allservices.php?work-category=<?php echo 'CAR Mechanic';  ?>';">
            ...
            <div class="box"  onclick="location.href='allservices.php?work-category=<?php echo 'Painter';  ?>';">
             ...
             <div class="box" onclick="location.href='allservices.php?work-category=<?php echo 'House Cleaning Service';  ?>';">
