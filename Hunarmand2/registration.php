...
$sql = "INSERT INTO workerregistration(fullName, phoneNum, email, password, CNIC, userType, workCategory, addresss, userName) VALUES('$fullName','$phoneNum','$email','$password','$cnic','$userType','$workCategory','$address','$userName')";
